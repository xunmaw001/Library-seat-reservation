...
public class ZuoweixinxiController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZuoweixinxiEntity zuoweixinxi, 
		HttpServletRequest request){
        EntityWrapper<ZuoweixinxiEntity> ew = new EntityWrapper<ZuoweixinxiEntity>();
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<ZuoweixinxiEntity> ew = new EntityWrapper<ZuoweixinxiEntity>();
        List<Map<String, Object>> result = zuoweixinxiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<ZuoweixinxiEntity> ew = new EntityWrapper<ZuoweixinxiEntity>();
        List<Map<String, Object>> result = zuoweixinxiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<ZuoweixinxiEntity> ew = new EntityWrapper<ZuoweixinxiEntity>();
        List<Map<String, Object>> result = zuoweixinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,ZuoweixinxiEntity zuoweixinxi, HttpServletRequest request){
        EntityWrapper<ZuoweixinxiEntity> ew = new EntityWrapper<ZuoweixinxiEntity>();
        int count = zuoweixinxiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zuoweixinxi), params), params));
