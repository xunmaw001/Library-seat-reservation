...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
				...
				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>状态：</view>
					<view  class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"1.5","fontSize":"28rpx","color":"#50605d"}'>{{detail.zhuangtai}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"20rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 0px 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>座位详情</view>
					<view class="rich-text" :style='{"minHeight":"240rpx","width":"100%","padding":"0","margin":"0","lineHeight":"1.5","color":"#50605d"}'>
						<rich-text :nodes="detail.zuoweixiangqing"></rich-text>
					</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"10rpx 24rpx","flexWrap":"wrap","background":"#f3fcf9","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","background":"rgb(255, 170, 51)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('zuoweixinxi','预约')" @tap="onAcrossTap('yuyuexuanzuo','','zhuangtai','该座位无法预约',zhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >预约</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","background":"rgb(255, 170, 51)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('zuoweixinxi','预约')" @tap="onAcrossTap('yuyuexuanzuo','','zhuangtai','该座位无法预约',zhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >预约</button>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				user: {},
				storeupFlag: 0,
                zhuangtaiCrossSelect:'使用中,闲置'.split(','),
				count: 0,
				timer: null
			}
		},
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','zuoweixinxi');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','zuoweixinxi');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('zuoweixinxi', this.id);
				this.detail = res.data;
				// 轮播图片
				this.swiperList = this.detail.zuoweitupian ? this.detail.zuoweitupian.split(",") : [];
				//修改富文本的图片样式
				this.detail.zuoweixiangqing = this.detail.zuoweixiangqing.replace(/img src/gi,"img style=\"width:100%;\" src");
			},
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discusszuoweixinxi/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
