...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			...
			<view class="uni-product-list" :style='{"padding":"24rpx","margin":"0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="uni-product" :style='{"border":"2rpx solid #d8f0e7","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 40rpx","backgroundColor":"#e9f8f1","borderRadius":"16rpx","flexWrap":"wrap","display":"flex","width":"48%","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(product,index) in list" :key="index">
					<view class="uni-product-title" :style='{"padding":"4rpx 20rpx","whiteSpace":"nowrap","overflow":"hidden","color":"#333","width":"70%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","order":"1"}'>{{product.zhanghao}}</view>
					<image :style='{"padding":"0","margin":"20rpx","objectFit":"cover","borderRadius":"40rpx","display":"block","width":"calc(100% - 40rpx)","height":"300rpx"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.touxiang)" :src="product.touxiang.split(',')[0]"></image>
					<image :style='{"padding":"0","margin":"20rpx","objectFit":"cover","borderRadius":"40rpx","display":"block","width":"calc(100% - 40rpx)","height":"300rpx"}' mode="aspectFill" class="uni-product-image" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
		...
		<button :style='{"border":"0","boxShadow":"0 0px 0px rgba(0,0,0,.3)","color":"#666","bottom":"40rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#c8e3c3","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"0 0px 0px rgba(0,0,0,.3)","color":"#666","bottom":"40rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#c8e3c3","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
