		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
            <view :style='{"width":"100%","padding":"32rpx 24rpx 24rpx 24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>关联表id：</view>
				...
				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>用户名：</view>
					<view  class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"1.5","fontSize":"28rpx","color":"#50605d"}'>{{detail.nickname}}</view>
				</view>



				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>评论内容</view>
					<view class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"1.5","fontSize":"28rpx","color":"#50605d"}'>{{detail.content}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>回复内容</view>
					<view class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"1.5","fontSize":"28rpx","color":"#50605d"}'>{{detail.reply}}</view>
				</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			let cleanType = uni.getStorageSync('discussdiscusstushuguanCleanType')
			if(cleanType){
				uni.removeStorageSync('discussdiscusstushuguanCleanType')
				this.mescroll.num = 1
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','discusstushuguan');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','discusstushuguan');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('discusstushuguan', this.id);
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussdiscusstushuguan', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussdiscusstushuguan/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
