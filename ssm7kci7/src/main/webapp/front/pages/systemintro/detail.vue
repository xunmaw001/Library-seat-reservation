		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
            <view :style='{"width":"100%","padding":"32rpx 24rpx 24rpx 24rpx","background":"#fff","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>标题：</view>
					<view  class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"1.5","fontSize":"28rpx","color":"#50605d"}'>{{detail.title}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"40rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","background":"none","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>副标题：</view>
					<view  class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"1.5","fontSize":"28rpx","color":"#50605d"}'>{{detail.subtitle}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"padding":"20rpx 20rpx","margin":"0 0 24rpx 0","borderColor":"#c9f2e4","borderRadius":"20rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"#f3fcf9","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 0px 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","fontWeight":"bold"}'>内容</view>
