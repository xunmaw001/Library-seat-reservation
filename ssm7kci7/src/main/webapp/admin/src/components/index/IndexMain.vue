<template>
	<div style="height: 100%;">
		<index-aside v-if="'vertical' == 'vertical'" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"60px 0 0","overflow":"hidden","top":"0","left":"0","background":"#fff","bottom":"0","width":"190px","fontSize":"0px","position":"fixed","height":"calc(100% - 60px)","zIndex":"1001"}'></index-aside>
